...
const InvestmentPlan = ({plantime, plan_Price, totleplantime, saveprice, planfeature, buyplan="Buy Plan", isActive = false}) => {
    return (
        <>
        <div class="col-12 col-lg-6 col-xl-4">
            <div class={`main-card ${isActive ?  'active' : 'hello'}`}>
                <div class="main-card_title">{plantime}</div>
                <div class="pricing">{plan_Price}<span class="small">/{totleplantime}</span></div>
