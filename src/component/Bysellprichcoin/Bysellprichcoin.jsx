...
const BysellPricecoin = ({cryptoPrice, cryptoamount, barvaluenow, barvaluemax, barwidth, isHighlighted }) => {
  return (
    <>
     <li className="cryptoamount">
        <div className="contantside d-flex justify-content-between align-items-center px-2">
        <span className={`Price fs-12 ${isHighlighted ? 'text-theme4' : 'text-theme3'}`}>{cryptoPrice}</span>
...
export default BysellPricecoin